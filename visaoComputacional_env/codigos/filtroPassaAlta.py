...
def filtroPassaAlta(imagem):
    ...
    # matrizPassaAlta = [[ 0, -1,  0],
    #                    [-1,  5, -1],
    #                    [ 0, -1,  0]]

    matrizPassaAlta = [[    0, -1/16,     0],
                       [-1/16, 20/16, -1/16],
                       [    0, -1/16,     0]]
...
imagem = cv2.imread('../images/desfocada.png', cv2.IMREAD_GRAYSCALE)
resultado = deepcopy(imagem)

for i in range(1):
    resultado = filtroPassaAlta(resultado)
